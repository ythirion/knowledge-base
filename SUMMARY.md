...
* [Software craftsmanship](software-craftsmanship/README.md)
  ...
  * [Katas](software-craftsmanship/code-katas/README.md)
    ...
    * [Refactoring du Bouchonnois](software-craftsmanship/code-katas/refactoring-du-bouchonnois/README.md)
      * [1) se faire une idée du code](software-craftsmanship/code-katas/refactoring-du-bouchonnois/1-se-faire-une-idee-du-code.md)
      * [2) "Treat warnings as errors"](software-craftsmanship/code-katas/refactoring-du-bouchonnois/2-treat-warnings-as-errors.md)
      * [3) Let's kill some mutants](software-craftsmanship/code-katas/refactoring-du-bouchonnois/3-lets-kill-some-mutants.md)
      * [4) Améliorer la lisibilité des tests](software-craftsmanship/code-katas/refactoring-du-bouchonnois/4-ameliorer-la-lisibilite-des-tests.md)
      * [5) "Approve Everything"](software-craftsmanship/code-katas/refactoring-du-bouchonnois/5-approve-everything.md)
      * [6) Définir des propriétés](software-craftsmanship/code-katas/refactoring-du-bouchonnois/6-definir-des-proprietes.md)
